...
Проект нужно компилировать только XeLaTeX'ом (он же компилятор по умолчанию). Корневой файл - spisok-example.tex У класса spisok-article есть две опции: 

  - language - язык статьи. Если пишете англоязычную статью, используйте
  \documentclass[language=english]{spisok-article}
  
  - times - использование несвободных шрифтов. При работе в Папирии 
  бесполезна.
